...
export const translations = {
  en: {
    ...
    searchPlaceholder: 'Search residents, employees, jobs...',
    // Welcome
    ...
    jobTrackingDesc: 'Track maintenance jobs and employee assignments in real-time',
  ...
  am: {
    ...
    jobTracking: 'የሥራ ክትትል',
    jobTrackingDesc: 'የጥገና ሥራዎችን እና የሠራተኛ ምደባዎችን በቀጥታ ይከታተሉ',
